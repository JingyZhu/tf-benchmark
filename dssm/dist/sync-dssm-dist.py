...
flags.DEFINE_integer('max_steps', int(100000/FLAGS.num_workers), 'Number of steps to run trainer.')
flags.DEFINE_integer('epoch_steps', int(2000/FLAGS.num_workers), "Number of steps in one epoch")
flags.DEFINE_integer('test_size', int(10/FLAGS.num_workers), "Number of test batches in one pickle pack.")
